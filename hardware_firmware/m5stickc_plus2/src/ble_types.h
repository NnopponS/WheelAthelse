...
enum class Cmd : uint8_t {
    ...
    SetWheel   = 0x08,   // v1.1.0 — 0x4C='L' / 0x52='R' / 0x43='C'
...
// A failed notify must not be retried by the 1 ms BLE owner loop. Exponential
// backoff gives the controller time to release mbufs while keeping recovery
// latency bounded to one 100 Hz batch period.
...
// Wrap-safe millis() deadline comparison. Valid because retry delays are far
// below INT32_MAX milliseconds.
