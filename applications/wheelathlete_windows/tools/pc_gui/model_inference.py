...
def model_runtime_status(repo_root: Path) -> tuple[bool, str]:
    ...
    if missing:
        return (
            ...
            + ", ".join(missing)
            + ". Install applications/wheelathlete_windows/tools/pc_gui/requirements-model.txt.",
        )
    ...
    *,
    ...
    try:
        ...
        raise ModelInferenceError(
            "NumPy is required. Install applications/wheelathlete_windows/tools/pc_gui/requirements-model.txt."
        ) from exc
...
def run_session_model(
    ...
    try:
        ...
        raise ModelInferenceError(
            "BiWheel3D runtime could not be imported. Install applications/wheelathlete_windows/tools/pc_gui/requirements-model.txt."
        ) from exc
