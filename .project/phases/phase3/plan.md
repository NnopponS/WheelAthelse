...
> Phase 1 (data collection) complete — see `.project/phases/phase1/plan.md`.
...
See `.project/phases/phase3/architecture.md` for the full delta.
...
2. build skill reads this `plan.md` + `architecture.md` +
   `progress.md` first.
