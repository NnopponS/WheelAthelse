...
- GitHub release-page replacement complete: v1.8.0 and v1.8.1 Release entries
  were removed while both historical tags were retained. v1.8.2 is the latest
  published Release at source commit `30446c5`, with zero uploaded assets.
  Pre-delete metadata and asset digests are saved under ignored
  `.project/local/v1.8.2/github-releases-before-replacement/`. Do not upload the
  unsigned local Windows artifacts or a `latest.json` update offer.
