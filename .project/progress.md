...
| 28 | Align countdown to next whole second | dart-flutter-patterns + tdd-workflow | pending | - | - | - |
| 29 | Convert `timestamp_synced_ms` to absolute UTC | dart-flutter-patterns + tdd-workflow | pending | - | - | - |
